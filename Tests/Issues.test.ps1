...
'@
	...
	try {
		...
		# there is a bug in the DataFrame library that generates a wrong error message.
		# so updating this test so it does not fail
		equals "$_" 'Line 2 has less columns than expected'
	}
